          ...
          {items.map((item, i) => (
            <div key={i} className={`grid grid-cols-1 md:grid-cols-2 ${i !== 0 ? 'border-t border-[#e5e5ea] dark:border-[#1e2230]' : ''}`}>
              <div className="p-5 md:p-7 md:border-r border-[#e5e5ea] dark:border-[#1e2230] bg-white dark:bg-[#11141c]">
                <div className="text-[10px] font-bold text-[#ff5252] tracking-[1.5px] mb-2">Pain {String(i + 1).padStart(2, '0')}</div>
                <h3 className="text-sm font-bold text-[#1d1d1f] dark:text-[#e8e8ed] mb-1.5">{item.pain}</h3>
